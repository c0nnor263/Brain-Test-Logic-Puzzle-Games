...
class MainActivity : ComponentActivity() {
    ...
    @Inject
    lateinit var playGamesEventRepository: PlayGamesEventRepository
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            WordefullTheme {
                val localeDefaultLanguage: String = remember {
                ...
                val language = viewModel.getLanguage()
                    .collectAsStateWithLifecycle(localeDefaultLanguage)

                val costs = remember(userVipType.value) {
                    CostsInfo().calculateCosts(userVipType.value)
                }

                val localeFromLanguage = remember(language.value) {
                ...
                CompositionLocalProvider(
                    ...
                    LocalCosts provides costs,
                    LocalLocale provides localeFromLanguage
                ) {
